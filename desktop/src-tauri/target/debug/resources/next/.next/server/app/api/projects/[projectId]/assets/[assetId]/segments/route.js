(()=>{var a={};a.id=496,a.ids=[496],a.modules={261:a=>{"use strict";a.exports=require("next/dist/shared/lib/router/utils/app-paths")},10846:a=>{"use strict";a.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},29294:a=>{"use strict";a.exports=require("next/dist/server/app-render/work-async-storage.external.js")},44870:a=>{"use strict";a.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},63033:a=>{"use strict";a.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},73024:a=>{"use strict";a.exports=require("node:fs")},76518:(a,b,c)=>{"use strict";c.d(b,{gy:()=>f,J3:()=>g,GU:()=>h,sy:()=>j});var d=c(92913);let e=require("node:child_process");function f(a){(0,d.L)().prepare("DELETE FROM asset_search WHERE asset_id = ?").run(a)}function g(a){(0,d.L)().prepare("DELETE FROM asset_search WHERE project_id = ?").run(a)}function h(a){let b,c=(0,d.L)(),e=Math.min(Math.max(a.limit??50,1),200),f=0===(b=a.query.trim().split(/\s+/g).map(a=>a.replace(/["']/g,"").trim()).map(a=>a.replace(/[^a-zA-Z0-9_]+/g,"").trim()).filter(Boolean)).length?"":b.map(a=>`${a}*`).join(" ");return f?c.prepare(`SELECT
        a.*,
